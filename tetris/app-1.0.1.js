! function(t) {
	...
	function o(t, e, n, i) {
		...
		if (Array.isArray(t))
			...
			if (g) {
				var _, b = g.call(t);
				if (g !== t.entries)
					for (var w = 0; !(_ = b.next())
						.done;) d = _.value, h = m + r(d, w++), v += o(d, h, n, i);
				else
					for (; !(_ = b.next())
						.done;) {
						var E = _.value;
				...
				var C = "",
					S = String(t);
				a("31", "[object Object]" === S ? "object with keys {" + Object.keys(t)
					.join(", ") + "}" : S, C)
			}
		}
		return v
		...
		i = (n(63), n(7), {
			...
			receiveComponent: function(t, e, n, i) {
				...
				if (e !== a || i !== t._context) {
					...
					u && o.detachRefs(t, a), t.receiveComponent(e, n, i), u && t._currentElement && null != t._currentElement.ref && n.getReactMountReady()
						.enqueue(r, t)
				}
			},
		...
		mountComponent: function(t, e, n, r) {
			...
			switch (this._tag) {
				...
				case "video":
					...
					break;
				case "input":
					k.mountWrapper(this, i, e), i = k.getHostProps(this, i), t.getReactMountReady()
				...
				case "option":
					...
					break;
				case "select":
					I.mountWrapper(this, i, e), i = I.getHostProps(this, i), t.getReactMountReady()
						.enqueue(f, this);
					break;
				case "textarea":
					R.mountWrapper(this, i, e), i = R.getHostProps(this, i), t.getReactMountReady()
						.enqueue(l, this), t.getReactMountReady()
						.enqueue(f, this)
			}
			o(this, i);
	...
	var o, i = n(3),
		...
		v = "_reactListenersID" + String(Math.random())
		.slice(2),
		m = i({}, u, {
	...
	var i = n(49),
		...
		u = {},
		s = {};
	i.canUseDOM && (s = document.createElement("div")
	...
	function o(t, e, n) {
		var r, o, i = s.getNodeFromInstance(t)
			.options;
		if (e) {
	...
	var b = 1,
		w = {
			...
			mountComponent: function(t, e, n, s) {
				...
				var E;
				return E = g.unstable_handleError ? this.performInitialMountWithErrorHandling(l, e, n, t, s) : this.performInitialMount(l, e, n, t, s), g.componentDidMount && t.getReactMountReady()
			...
			_performComponentUpdate: function(t, e, n, r, o, i) {
				...
				l && (a = c.props, u = c.state, s = c.context), c.componentWillUpdate && c.componentWillUpdate(e, n, r), this._currentElement = t, this._context = i, c.props = e, c.state = n, c.context = r, this._updateRenderedComponent(o, i), l && o.getReactMountReady()
	...
	var B = {
		...
		_renderSubtreeIntoContainer: function(t, e, n, r) {
			...
			var g = o(n),
				...
				b = c(n),
				w = _ && !l && !b,
				C = B._renderNewRootComponent(u, n, w, a)
	...
	! function(e, n) {
		...
		function M(t) {
			return null === t || void 0 === t ? U()
				.toKeyedSeq() : i(t) ? a(t) ? t.toSeq() : t.fromEntrySeq() : B(t)
		}
		...
		function R(t) {
			return (null === t || void 0 === t ? U() : i(t) ? a(t) ? t.entrySeq() : t : F(t))
				.toSetSeq()
		}
		...
		function B(t) {
			var e = Array.isArray(t) ? new A(t)
				.fromEntrySeq() : x(t) ? new L(t)
				.fromEntrySeq() : S(t) ? new D(t)
				.fromEntrySeq() : "object" == typeof t ? new N(t) : void 0;
		...
		function K(t, e, n, r) {
			return Array.isArray(e) ? t.call(r, n, I(e)
				.map(function(n, r) {
					return K(t, n, r, e)
				})) : J(e) ? t.call(r, n, M(e)
				.map(function(n, r) {
		...
		function ft(t) {
			return null === t || void 0 === t ? Et() : pt(t) && !c(t) ? t : Et()
		...
		function Nt(t, e, n, r) {
			...
			var s = i.value,
				c = o ? yn : t.get(s, yn),
				l = Nt(c, e, n, r);
			return l === c ? t : l === yn ? t.remove(s) : (o ? Et() : t)
				.set(s, l)
		}
		...
		function Gt(t) {
			return null === t || void 0 === t ? ee() : Zt(t) ? t : ee()
				.withMutations(function(e) {
					var r = n(t);
					lt(r.size), r.forEach(function(t, n) {
						return e.set(n, t)
		...
		function ne(t, e, n) {
			...
			if (n === yn) {
				...
				a.size >= vn && a.size >= 2 * i.size ? (o = a.filter(function(t, e) {
					...
					.flip()
					.toMap(), t.__ownerID && (r.__ownerID = o.__ownerID = t.__ownerID)) : (r = i.remove(e), o = u === a.size - 1 ? a.pop() : a.set(u, void 0))
			} else if (s) {
		...
		function de(t, e, n, r) {
			...
			return c.size = 0 === u ? u : t.size && u || void 0, !r && j(t) && u >= 0 && (c.get = function(e, n) {
				...
				if (0 !== u && n) return this.cacheResult()
					.__iterator(e, n);
		...
		function Ce(t, n, r) {
			...
			return o.size = new A(r)
				...
				.min(), o.__iterate = function(t, e) {
					for (var n, r = this.__iterator(wn, e), o = 0; !(n = r.next())
						.done && t(n.value, o++, this) !== !1;);
					return o
		...
		function Oe(t) {
			return Object.create((a(t) ? M : u(t) ? I : R)
				.prototype)
		}
		...
		function je(t) {
			return null === t || void 0 === t ? ze() : Ue(t) && !c(t) ? t : ze()
				.withMutations(function(e) {
					var n = o(t);
		...
		function qe(t) {
			return null === t || void 0 === t ? We() : Ve(t) ? t : We()
				.withMutations(function(e) {
					var n = o(t);
					lt(n.size), n.forEach(function(t) {
						return e.add(t)
		...
		function Ke(t) {
			return null === t || void 0 === t ? Xe() : He(t) ? t : Xe()
				.unshiftAll(t)
		}
		...
		function Qe(t, e) {
			...
			return Object.keys(e)
				.forEach(n), Object.getOwnPropertySymbols && Object.getOwnPropertySymbols(e)
				.forEach(n), t
		}
		...
		w.prototype.toString = function() {
			...
			return !this._cache && this.__iterateUncached && (this._cache = this.entrySeq()
				.toArray(), this.size = this._cache.length), this
		...
		e.Iterator = w, Qe(e, {
			...
			__toString: function(t, e) {
				return 0 === this.size ? t + e : t + " " + this.toSeq()
			...
			getIn: function(t, e) {
				for (var n, r = this, o = Ie(t); !(n = o.next())
					.done;) {
					var i = n.value;
			...
			n.open("GET", t, !0), n.responseType = "arraybuffer", n.onload = function() {
				e.decodeAudioData(n.response, function(t) {
					...
					s.killStart = function() {
						...
						s.killStart(), i.default.getState()
							.get("music") && n()
			...
			want: function(t, e) {
				...
				return r.every(function(t, r) {
					return t.every(function(t, i) {
						return !(n[1] < 0) && (!(n[1] + o > 10) && (n[0] + r < 0 || !(n[0] + r >= 20) && (!t || !e.get(n[0] + r)
							.get(n[1] + i))))
					})
				})
			},
	...
	var s = function() {
		...
		q = function(t) {
			function e() {
				i(this, e);
				var t = a(this, (e.__proto__ || Object.getPrototypeOf(e))
					.call(this));
				return t.state = {
	...
	var u = function() {
		...
		C = function(t) {
			function e() {
				o(this, e);
				var t = i(this, (e.__proto__ || Object.getPrototypeOf(e))
					.call(this));
				return t.state = {
					clearLines: !1,
					animateColor: 2,
	...
	var o = n(207),
		...
		d = {
			...
			nextAround: function(t, e) {
				...
				var n = a.default.getState()
					.get("points") + 10 + 2 * (a.default.getState()
						.get("speedRun") - 1);
			...
			clearLines: function t(e, n) {
				...
				var u = a.default.getState()
					.get("points") + l.clearPoints[n.length - 1];
				d.dispatchPoints(u);
			...
			dispatchPoints: function(t) {
				a.default.dispatch(c.default.points(t)), t > 0 && t > a.default.getState()
					.get("max") && a.default.dispatch(c.default.max(t))
			}
		};
	e.default = d
}, function(t, e, n) {
	...
	var u = function() {
		...
		v = function(t) {
			function e() {
				return o(this, e), i(this, (e.__proto__ || Object.getPrototypeOf(e))
		...
		g = function(t) {
			...
			return a(e, t), u(e, [{
				...
				value: function() {
					...
					for (var i = ("" + this.props.number)
						.split(""), a = 0, u = this.props.length - i.length; a < u; a++) i.unshift("n");
					return m(i)
				}
			}]), e
		}(c.default.Component);
	...
	var s = function() {
		...
		y = function(t) {
			function e() {
				return i(this, e), a(this, (e.__proto__ || Object.getPrototypeOf(e))
					.apply(this, arguments))
			}
			return u(e, t), s(e, [{
				key: "shouldComponentUpdate",
	...
	var o = n(220),
		...
		f = n(217),
		p = function(t) {
			t.dispatch(s.default.keyboard.down(!0)), null !== t.getState()
				.get("cur") ? a.default.down({
					key: "down",
					begin: 40,
					interval: 40,
					callback: function(e) {
	...
	var o = n(220),
		...
		f = n(217),
		p = function(t) {
			t.dispatch(s.default.keyboard.rotate(!0)), null !== t.getState()
				.get("cur") ? a.default.down({
					key: "rotate",
					once: !0,
					callback: function() {
	...
	var o = n(269),
		...
		u = r(a),
		s = function(t) {
			t.dispatch(u.default.keyboard.music(!0)), t.getState()
				.get("lock") || i.default.down({
					key: "s",
					once: !0,
					callback: function() {
						t.getState()
							.get("lock") || t.dispatch(u.default.music(!t.getState()
								.get("music")))
					}
				})
		},
	...
	var o = n(269),
		...
		c = r(s),
		l = function(t) {
			t.dispatch(c.default.keyboard.reset(!0)), t.getState()
				.get("lock") || (null !== t.getState()
					.get("cur") ? i.default.down({
						key: "r",
						once: !0,
						callback: function() {
							u.default.overStart()
	...
	(function(t) {
		...
		function c(t, e, n, r) {
			return s(e), e <= 0 ? i(t, e) : void 0 !== n ? "string" == typeof r ? i(t, e)
				.fill(n, r) : i(t, e)
				.fill(n) : i(t, e)
		}
		...
		function v(t) {
			if (t >= o()) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + o()
				.toString(16) + " bytes");
			return 0 | t
		}
		...
		a.prototype.slice = function(t, e) {
			...
			if ("number" == typeof t)
				...
				var u = a.isBuffer(t) ? t : W(new a(t, r)
						.toString()),
					s = u.length;
	...
	e.isValid = function(t) {
		...
		for (var r = Object.keys(e.Patterns)
			.length, o = 0, i = 1 / 0, a = 0; a < r; a++) {
			n(a), e.applyMask(a, t);
	...
	function r(t, e) {
		var n = t.a / 255,
			r = e + '="' + t.hex + '"';
		return n < 1 ? r + " " + e + '-opacity="' + n.toFixed(2)
			.slice(1) + '"' : r
	}
